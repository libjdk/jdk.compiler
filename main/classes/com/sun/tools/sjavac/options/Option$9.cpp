...
$MethodInfo _Option$9_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(Option$9::*)($String*,int32_t,$String*,$String*)>(&Option$9::init$))},

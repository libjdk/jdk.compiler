...
$MethodInfo _Option$8_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(Option$8::*)($String*,int32_t,$String*,$String*)>(&Option$8::init$))},

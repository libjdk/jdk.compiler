...
class $export Type$ArrayType : public ::com::sun::tools::javac::code::Type, public ::com::sun::tools::javac::jvm::PoolConstant$LoadableConstant, public ::javax::lang::model::type::ArrayType {

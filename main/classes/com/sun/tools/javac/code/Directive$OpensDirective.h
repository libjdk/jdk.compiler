#ifndef _com_sun_tools_javac_code_Directive$OpensDirective_h_
#define _com_sun_tools_javac_code_Directive$OpensDirective_h_
//$ class com.sun.tools.javac.code.Directive$OpensDirective
//$ extends com.sun.tools.javac.code.Directive
//$ implements javax.lang.model.element.ModuleElement$OpensDirective
...
class $export Directive$OpensDirective : public ::com::sun::tools::javac::code::Directive, public ::javax::lang::model::element::ModuleElement$OpensDirective {
	$class(Directive$OpensDirective, $NO_CLASS_INIT, ::com::sun::tools::javac::code::Directive, ::javax::lang::model::element::ModuleElement$OpensDirective)
public:
...
#endif // _com_sun_tools_javac_code_Directive$OpensDirective_h_
...
class $export Symbol$DynamicVarSymbol : public ::com::sun::tools::javac::code::Symbol$VarSymbol, public ::com::sun::tools::javac::jvm::PoolConstant$Dynamic, public ::com::sun::tools::javac::jvm::PoolConstant$LoadableConstant {

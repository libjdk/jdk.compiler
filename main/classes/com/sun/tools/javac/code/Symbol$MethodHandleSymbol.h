...
class $export Symbol$MethodHandleSymbol : public ::com::sun::tools::javac::code::Symbol$MethodSymbol, public ::com::sun::tools::javac::jvm::PoolConstant$LoadableConstant {

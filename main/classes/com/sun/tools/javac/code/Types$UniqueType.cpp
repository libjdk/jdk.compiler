...
$MethodInfo _Types$UniqueType_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/tools/javac/code/Type;Lcom/sun/tools/javac/code/Types;)V", nullptr, $PUBLIC, $method(static_cast<void(Types$UniqueType::*)($Type*,$Types*)>(&Types$UniqueType::init$))},

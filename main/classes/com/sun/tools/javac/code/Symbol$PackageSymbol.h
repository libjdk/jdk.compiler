...
class $export Symbol$PackageSymbol : public ::com::sun::tools::javac::code::Symbol$TypeSymbol {
...
public:
	...
	class $export MemberClass0$ : public ::javax::lang::model::element::PackageElement {
	public:

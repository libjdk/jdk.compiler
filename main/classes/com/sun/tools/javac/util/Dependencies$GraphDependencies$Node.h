...
class $export Dependencies$GraphDependencies$Node : public ::com::sun::tools::javac::util::GraphUtils$AbstractNode, public ::com::sun::tools::javac::util::GraphUtils$DottableNode {

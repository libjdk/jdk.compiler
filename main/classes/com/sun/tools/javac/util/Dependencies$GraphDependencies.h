...
class $export Dependencies$GraphDependencies : public ::com::sun::tools::javac::util::Dependencies, public ::java::io::Closeable, public ::com::sun::tools::javac::code::Symbol$Completer {

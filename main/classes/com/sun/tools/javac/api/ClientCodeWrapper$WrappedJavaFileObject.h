...
class $export ClientCodeWrapper$WrappedJavaFileObject : public ::com::sun::tools::javac::api::ClientCodeWrapper$WrappedFileObject, public ::javax::tools::JavaFileObject {

...
$FieldInfo _DocCommentParser$13_FieldInfo_[] = {
	{"this$0", "Lcom/sun/tools/javac/parser/DocCommentParser;", nullptr, $FINAL | $SYNTHETIC, $field(DocCommentParser$13, this$0)},
	{}
};

$MethodInfo _DocCommentParser$13_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/tools/javac/parser/DocCommentParser;Lcom/sun/tools/javac/parser/DocCommentParser$TagParser$Kind;Lcom/sun/source/doctree/DocTree$Kind;)V", nullptr, 0, $method(static_cast<void(DocCommentParser$13::*)($DocCommentParser*,$DocCommentParser$TagParser$Kind*,$DocTree$Kind*)>(&DocCommentParser$13::init$))},
...
$EnclosingMethodInfo _DocCommentParser$13_EnclosingMethodInfo_ = {
	"com.sun.tools.javac.parser.DocCommentParser",
	"createTagParsers",
	"()Ljava/util/Map;"
};

$InnerClassInfo _DocCommentParser$13_InnerClassesInfo_[] = {
...
$ClassInfo _DocCommentParser$13_ClassInfo_ = {
	$ACC_SUPER,
	"com.sun.tools.javac.parser.DocCommentParser$13",
	"com.sun.tools.javac.parser.DocCommentParser$TagParser",
	nullptr,
	_DocCommentParser$13_FieldInfo_,
	_DocCommentParser$13_MethodInfo_,
	nullptr,
	&_DocCommentParser$13_EnclosingMethodInfo_,
	_DocCommentParser$13_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"com.sun.tools.javac.parser.DocCommentParser"
...
$Object* allocate$DocCommentParser$13($Class* clazz) {
	return $of($alloc(DocCommentParser$13));
}

void DocCommentParser$13::init$($DocCommentParser* this$0, $DocCommentParser$TagParser$Kind* k, $DocTree$Kind* tk) {
	$set(this, this$0, this$0);
	$DocCommentParser$TagParser::init$(k, tk);
}

$DCTree* DocCommentParser$13::parse(int32_t pos) {
	...
	return $cast($DCTree, $nc($($nc(this->this$0->m)->at(pos)))->newProvidesTree(ref, description));
}

DocCommentParser$13::DocCommentParser$13() {
}

$Class* DocCommentParser$13::load$($String* name, bool initialize) {
	$loadClass(DocCommentParser$13, name, initialize, &_DocCommentParser$13_ClassInfo_, allocate$DocCommentParser$13);
	return class$;
}

$Class* DocCommentParser$13::class$ = nullptr;

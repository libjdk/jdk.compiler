...
class $export JavaTokenizer$BasicComment : public ::com::sun::tools::javac::parser::UnicodeReader$PositionTrackingReader, public ::com::sun::tools::javac::parser::Tokens$Comment {

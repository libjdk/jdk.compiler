...
class $export DeferredAttr$CheckStuckPolicy : public ::com::sun::tools::javac::comp::DeferredAttr$PolyScanner, public ::com::sun::tools::javac::comp::DeferredAttr$DeferredStuckPolicy, public ::com::sun::tools::javac::comp::Infer$FreeTypeListener {

...
$MethodInfo _JCTree$JCBreak_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/tools/javac/util/Name;Lcom/sun/tools/javac/tree/JCTree;)V", nullptr, $PROTECTED, $method(static_cast<void(JCTree$JCBreak::*)($Name*,$JCTree*)>(&JCTree$JCBreak::init$))},

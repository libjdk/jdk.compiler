#ifndef _com_sun_tools_javac_tree_JCTree$JCReturn_h_
#define _com_sun_tools_javac_tree_JCTree$JCReturn_h_
...
class $export JCTree$JCReturn : public ::com::sun::tools::javac::tree::JCTree$JCStatement, public ::com::sun::source::tree::ReturnTree {
	$class(JCTree$JCReturn, $NO_CLASS_INIT, ::com::sun::tools::javac::tree::JCTree$JCStatement, ::com::sun::source::tree::ReturnTree)
public:
	JCTree$JCReturn();
...
#endif // _com_sun_tools_javac_tree_JCTree$JCReturn_h_
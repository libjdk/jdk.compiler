...
class $export DCTree$DCErroneous : public ::com::sun::tools::javac::tree::DCTree, public ::com::sun::source::doctree::ErroneousTree, public ::com::sun::tools::javac::util::JCDiagnostic$DiagnosticPosition {

...
$MethodInfo _JCTree$JCParens_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/tools/javac/tree/JCTree$JCExpression;)V", nullptr, $PROTECTED, $method(static_cast<void(JCTree$JCParens::*)($JCTree$JCExpression*)>(&JCTree$JCParens::init$))},

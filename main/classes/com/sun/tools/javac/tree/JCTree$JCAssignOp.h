#ifndef _com_sun_tools_javac_tree_JCTree$JCAssignOp_h_
#define _com_sun_tools_javac_tree_JCTree$JCAssignOp_h_
//$ class com.sun.tools.javac.tree.JCTree$JCAssignOp
//$ extends com.sun.tools.javac.tree.JCTree$JCOperatorExpression
//$ implements com.sun.source.tree.CompoundAssignmentTree
...
class $export JCTree$JCAssignOp : public ::com::sun::tools::javac::tree::JCTree$JCOperatorExpression, public ::com::sun::source::tree::CompoundAssignmentTree {
	$class(JCTree$JCAssignOp, $NO_CLASS_INIT, ::com::sun::tools::javac::tree::JCTree$JCOperatorExpression, ::com::sun::source::tree::CompoundAssignmentTree)
public:
	JCTree$JCAssignOp();
	...
	void init$(::com::sun::tools::javac::tree::JCTree$Tag* opcode, ::com::sun::tools::javac::tree::JCTree* lhs, ::com::sun::tools::javac::tree::JCTree* rhs, ::com::sun::tools::javac::code::Symbol$OperatorSymbol* operator$);
...
#endif // _com_sun_tools_javac_tree_JCTree$JCAssignOp_h_
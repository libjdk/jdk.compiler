#ifndef _com_sun_tools_javac_tree_JCTree$JCDoWhileLoop_h_
#define _com_sun_tools_javac_tree_JCTree$JCDoWhileLoop_h_
//$ class com.sun.tools.javac.tree.JCTree$JCDoWhileLoop
...
class $import JCTree$JCDoWhileLoop : public ::com::sun::tools::javac::tree::JCTree$JCStatement, public ::com::sun::source::tree::DoWhileLoopTree {
...
public:
	...
	void init$(::com::sun::tools::javac::tree::JCTree$JCStatement* body, ::com::sun::tools::javac::tree::JCTree$JCExpression* cond);
...
#endif // _com_sun_tools_javac_tree_JCTree$JCDoWhileLoop_h_
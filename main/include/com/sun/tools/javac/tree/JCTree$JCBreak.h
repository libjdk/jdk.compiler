#ifndef _com_sun_tools_javac_tree_JCTree$JCBreak_h_
#define _com_sun_tools_javac_tree_JCTree$JCBreak_h_
//$ class com.sun.tools.javac.tree.JCTree$JCBreak
...
class $import JCTree$JCBreak : public ::com::sun::tools::javac::tree::JCTree$JCStatement, public ::com::sun::source::tree::BreakTree {
	$class(JCTree$JCBreak, $NO_CLASS_INIT, ::com::sun::tools::javac::tree::JCTree$JCStatement, ::com::sun::source::tree::BreakTree)
public:
	JCTree$JCBreak();
...
#endif // _com_sun_tools_javac_tree_JCTree$JCBreak_h_
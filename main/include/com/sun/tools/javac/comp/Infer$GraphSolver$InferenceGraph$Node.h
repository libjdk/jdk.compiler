...
class $import Infer$GraphSolver$InferenceGraph$Node : public ::com::sun::tools::javac::util::GraphUtils$TarjanNode, public ::com::sun::tools::javac::util::GraphUtils$DottableNode {

...
class $import ClientCodeWrapper$WrappedStandardJavaFileManager : public ::com::sun::tools::javac::api::ClientCodeWrapper$WrappedJavaFileManager, public ::javax::tools::StandardJavaFileManager {
